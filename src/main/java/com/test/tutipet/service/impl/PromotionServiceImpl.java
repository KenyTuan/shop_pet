...
public class PromotionServiceImpl implements PromotionService {
    ...
    public List<PromotionRes> getAllPromotion() {
        return PromotionDtoConverter.toResponseList(promotionRepository.findAll());
    }

    @Override
    public PageRes<PromotionRes> getAllPromotionPage(int page, int size, String sortBy, String sortDir) {
        ...
        Page<Promotion> promotions = promotionRepository
                .findAllByObjectStatus(ObjectStatus.ACTIVE ,pageable);
    ...
    public PromotionRes updatePromotion(UpdatePromotionReq req, long id) {
        ...
        promotionToUpdate.setOrders(promotion.getOrders());
